...
const WhatsAppButton = () => {
  ...
  const number = settings.whatsappNumber || "5511934529229";
          ...
          >
            ...
            <div className="bg-[hsl(30,20%,95%)] p-4 min-h-[200px]">
              ...
              <div className="bg-white rounded-lg rounded-tl-none p-3 shadow-sm max-w-[85%] mb-4">
                <p className="text-sm text-foreground font-medium mb-1">Olá! 👋</p>
                <p className="text-sm text-muted-foreground">Como podemos ajudar? Selecione uma opção ou escreva sua mensagem:</p>
              </div>
