  ...
  useEffect(() => {
    const fetchPost = async () => {
      ...
      if (data) {
        ...
        if (meta)
          meta.setAttribute("content", data.meta_description || data.excerpt);
        ...
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          >
            ...
            <div className="flex items-center justify-between mt-6 pt-6 border-t border-border">
              <span className="text-sm text-muted-foreground">
                Por{" "}
                <strong className="text-foreground">{post.author_name}</strong>
              </span>
              <button
                onClick={() =>
          ...
          >
            ...
            <p className="text-accent-foreground/80 mb-6">
              Receba um diagnóstico gratuito da gestão financeira da sua
              empresa.
            </p>
            <a
              href={WHATSAPP_URL}
