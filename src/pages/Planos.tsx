...
import { WHATSAPP_URL as WHATSAPP_LINK } from "@/lib/whatsapp";
...
const steps = [
  {
    ...
    title: "Diagnóstico",
    description:
      "Analisamos a situação financeira atual da sua empresa e identificamos oportunidades de melhoria.",
  },
  {
    number: "02",
    title: "Implantação",
    description:
      "Configuramos as ferramentas e processos adequados para a organização financeira.",
  },
  {
    number: "03",
    title: "Gestão Contínua",
    description:
      "Mantemos o financeiro organizado com acompanhamento profissional dedicado.",
  },
];
...
const plans = [
  {
    ...
    badge: "Essencial",
    description:
      "Indicado para empresas com baixo volume de movimentação financeira.",
    items: [
  ...
  },
  {
    ...
    badge: "Mais popular",
    description:
      "Indicado para empresas com volume intermediário de movimentação financeira.",
    items: [
    ...
    <div className="min-h-screen bg-background font-montserrat">
      ...
      <section className="relative min-h-[60vh] md:min-h-[65vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container px-6 text-center py-32 md:py-40">
          ...
          >
            Todos os nossos planos contemplam estrutura completa para
        ...
        <div className="container px-6 max-w-5xl mx-auto">
          ...
          <div className="mt-14 text-center">
            ...
            <p className="text-muted-foreground mb-6 max-w-lg mx-auto">
              Você não precisa fazer tudo sozinho. Conte com uma equipe técnica
              cuidando da organização financeira da sua empresa.
            </p>
            <a
              href={WHATSAPP_LINK}
              target="_blank"
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {steps.map((step, i) => (
              ...
              >
                ...
                <h3 className="text-lg font-bold text-foreground mb-2 font-rajdhani">
                  {step.title}
                </h3>
      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="container px-6 max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {plans.map((plan, i) => (
              ...
              >
                {/* Header */}
                <div
                  className={`p-6 pb-4 ${plan.highlight ? "bg-accent text-accent-foreground" : "bg-card"}`}
                >
                  <div className="flex items-center justify-between mb-3">
                    <h3 className="font-rajdhani text-3xl font-extrabold tracking-wide">
                      {plan.name}
                    </h3>
                    <span
                  ...
                  <p
                    className={`text-sm leading-relaxed ${plan.highlight ? "text-accent-foreground/70" : "text-muted-foreground"}`}
                  >
                    {plan.description}
                  </p>
                </div>
                ...
                >
                  <p
                    className={`text-xs uppercase tracking-wider mb-1 ${plan.highlight ? "text-accent-foreground/50" : "text-muted-foreground"}`}
                  >
                    A partir de
                  </p>
                  <div className="flex items-baseline gap-1">
                    <span
                      className={`text-sm ${plan.highlight ? "text-accent-foreground/60" : "text-muted-foreground"}`}
                    >
                      R$
                    </span>
                    <span
                      className={`text-4xl font-bold font-rajdhani ${plan.highlight ? "text-accent-foreground" : "text-foreground"}`}
                    >
                      {plan.price}
                    </span>
                    <span
                ...
                {/* Items */}
                <div
                  className={`p-6 flex-1 ${plan.highlight ? "bg-accent" : "bg-card"}`}
                >
                ...
                {/* CTA */}
                <div
                  className={`p-6 pt-0 ${plan.highlight ? "bg-accent" : "bg-card"}`}
                >
                  <a
                    href={WHATSAPP_LINK}
                    target="_blank"
          ...
          <div className="max-w-3xl mx-auto mt-12 bg-muted/50 rounded-xl border border-border p-6 text-sm text-muted-foreground space-y-2">
            ...
            <p>
              O Demonstrativo de Resultados do Exercício (DRE) é um relatório
              opcional e pode ser contratado separadamente. Solicite orçamento
              caso tenha interesse na elaboração desse demonstrativo.
            </p>
            <p>
              Caso sua empresa não se enquadre nos limites apresentados,
              oferecemos planos personalizados, definidos conforme o volume de
              movimentações e a complexidade da operação financeira.
            </p>
          </div>
      ...
      <section className="py-16 md:py-24 bg-accent text-accent-foreground">
        <div className="container px-6 max-w-5xl mx-auto">
          <div className="text-center mb-14">
            ...
            <h2 className="font-rajdhani text-2xl md:text-4xl font-bold mb-3">
              PX Sistema
            </h2>
            <p className="text-accent-foreground/60 max-w-2xl mx-auto">
              Sistema de gestão empresarial para organizar vendas, emissão de
              notas e controle financeiro da sua empresa.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-5">
            {pxSistemaCategories.map((cat, i) => (
              ...
              >
                <h3 className="font-rajdhani text-base font-bold mb-4 text-accent-foreground">
                  {cat.title}
                </h3>
                <ul className="space-y-2.5">
                  {cat.items.map((item, j) => (
                    <li
                      key={j}
                      className="flex items-start gap-2.5 text-sm text-accent-foreground/75"
                    >
                      <Check className="w-4 h-4 text-primary flex-shrink-0 mt-0.5" />
                      <span>{item}</span>
                    </li>
          ...
          <div className="text-center mt-14 py-8 bg-white/5 border border-white/10 rounded-2xl">
            <p className="text-accent-foreground/50 text-sm mb-1">
              Mensalidade do sistema a partir de
            </p>
          ...
          <div className="mt-10 bg-white/5 border border-white/10 rounded-xl p-6 text-sm text-accent-foreground/60 space-y-2">
            ...
            <p>
              Oferecemos implantação, configuração inicial e treinamento para
              utilização do sistema.
            </p>
            <p>
              Caso sua empresa não contrate os planos de organização financeira
              da ProtechX, consulte valores para implantação e treinamento da
